---
title: "회사 생성"
api: "POST http://localhost:3000/api/v1/organization"
...
<ParamField body="fieldList" type="json">
  회사의 이름을 제외한 필드값을 설정합니다. name 에는 field 의 이름을 입력합니다. field 의 유형이 텍스트나 단일 선택인 경우에는 stringValue 에 값을 설정하고, field 의 유형이 숫자인 경우에는 numberValue 에 값을 설정하고, field 의 유형이 날짜인 경우에는 dateValue 에 값을 설정합니다.
</ParamField>
